 ...
 <link rel="icon" type="image/png" href="images/icons/bola.ico"/>
   ...
   <body class="game_info" data-spy="scroll" data-target=".header">
      ...
      <?php 
            ...
            echo "<tr><th>Presidente</th>
            <th>Vice Presidente</th>
            <th>Diretor</th>
            <th>Secretária</th></tr"; 
            while ($row = mysqli_fetch_assoc($qry)) 
               printf("<tr></tr><tr><td>"  . $row["Presidente"] . "</td><td>" . $row["VicePresidente"] . "</td><td>" . $row["Diretor"] . "</td><td>" . $row["Secretaria"] . "</td></tr>"); 
            echo "</table>";
