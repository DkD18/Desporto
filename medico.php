 ...
 <link rel="icon" type="image/png" href="images/icons/bola.ico"/>
   ...
   <body class="game_info" data-spy="scroll" data-target=".header">
      ...
      <?php 
            ...
            $sql = "SELECT * FROM dep_medico"; 
            $qry = mysqli_query($connect, $sql); 
            echo "<table class='table table-bordered table-responsive schedule-table' bgcolor='white'> "; 
            echo "<tr><th>Nome Médico</th>
            <th>Nome Fisioterapeuta</th>
            <th>Nome Nutricionista</th>
            <th>Nome Massagista</th> </tr"; 
            while ($row = mysqli_fetch_assoc($qry)) 
               printf("<tr></tr><tr><td>"  . $row["Nome_medico"] . "</td><td>" . $row["Nome_fisioterapeuta"] . "</td><td>" . $row["Nome_Nutricionista"] . "</td><td>" . $row["Nome_Massagista"] . "</td></tr>"); 
            echo "</table>";
