  ...
  <body>
    <div class="testbox">
      <form action="inserira.php" method="POST">
        ...
        <div class="item">
          <p>Nif</p>
          <input type="text" name="nif" placeholder="213456926" pattern="[0-9]{9}" required />
        </div>
        <div class="question">
          <p>Sexo</p>
          <div class="question-answer">
            <div>
              <input type="checkbox" value="Masculino" id="checkbox_1" name="sexo"/>
        ...
        <div class="item">
          ...
          <input type="text" name="ecd" placeholder="Caso for menor de 18 anos"/>
        </div>
         <div class="item">
          <p>Escalões</p>
