      ...
      <?php
        ...
        $dbname = "clube";
         ...
         $conn= mysqli_connect ($servername, $user, $password,$dbname ) or die ("problemas na ligação ao mysql");
            ...
            $sql = "SELECT * FROM jogos Inner join equipas where equipas.id_equipa=jogos.equipalocal and (Nome_Local like '%$pesquisar%' or Nome_Fora like '%$pesquisar%' or Escalao like '%$pesquisar%' or Data like '%$pesquisar%' or Hora like '%$pesquisar%' or Local like '%$pesquisar%' or Id_Dep like '%$pesquisar%')"; 
